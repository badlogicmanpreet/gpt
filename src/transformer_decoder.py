...
with open('/Users/manpreet.singh/git/gpt/dataset/input.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        # # Visualize token_embedding_table
        # plt.figure(figsize=(10, 10))
        # token_embeddings = token_emb[0].detach().cpu().numpy()  # Get the token embeddings for the first sequence in the batch
        # plt.imshow(token_embeddings, cmap='hot', interpolation='nearest')
        # plt.colorbar()
