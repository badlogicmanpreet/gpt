...
for step in range(max_steps):
    ...
    print(f"step: {step:4d} | loss: {loss.item():.6f} | lr: {lr:.4e} | norm: {norm:.4f}, dt: {dt:.2f}ms, tok/sec: {tokens_per_sec:.2f}") # loss is a scalar tensor, it is shipped from gpu to cpu (float), and printed
